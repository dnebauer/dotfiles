...
has '_stations_arrayref' => (
  ...
  isa => Types::Standard::ArrayRef [
    Types::Standard::InstanceOf ['App::My::RTNG::Station'],
  ],
  default     => sub { [] },
  handles_via => 'Array',
  handles     => {
...
App::My::RTNG::Stations - utility module modelling a group of stations

=head1 VERSION

This documentation is for C<App::My::RTNG::Stations> version 0.1.
...
Station to add. An L<App::My::RTNG::Station> object. Required.
...
App::My::RTNG::Station, namespace::clean, Moo, MooX::HandlesVia, strictures,
