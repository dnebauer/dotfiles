...
# • the script that loaded App::My::RTNG::Play did so by adding its
#   directory to @INC
...
App::My::RTNG::Play - play or pause a S<Radiotray NG> station

=head1 VERSION

This documentation is for C<App::My::RTNG::Play> version 0.1.

=head1 SYNOPSIS

    use App::My::RTNG::Play;

    App::My::RTNG::Play->new_with_options->run;
