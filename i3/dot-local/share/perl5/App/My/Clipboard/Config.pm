package App::My::Clipboard::Config;
...
App::My::Clipboard::Config - get configuration data

=head1 VERSION

This documentation is for C<App::My::Clipboard::Config> version 0.2.

=head1 SYNOPSIS

    use App::My::Clipboard::Config;

    my $conf = App::My::Clipboard::Config->new(stem => 'load-clipboard-data');
    my $data = $conf->run;

=head1 DESCRIPTION

Module used by L<App::My::Clipboard::Load> to get configuration data.
See L<App::My::Clipboard::Load> for more details.
...
See L<App::My::Clipboard::Load> for details.
