package App::My::KDEConnect::Config;
...
App::My::KDEConnect::Config - get configuration data

=head1 VERSION

This documentation is for C<App::My::KDEConnect::Config> version 0.1.

=head1 SYNOPSIS

    use App::My::KDEConnect::Config;

    my $conf = App::My::KDEConnect::Config->new(stem => 'kedconnect-monitor-data');
    my $data = $conf->run;

=head1 DESCRIPTION

Module used by L<App::My::KDEConnect::Monitor> to get configuration data.
See L<App::My::KDEConnect::Monitor> for more details.
...
See L<App::My::KDEConnect::Monitor> for details.
