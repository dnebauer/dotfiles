package App::My::Clipboard::Select;
...
App::My::Clipboard::Select - user selects a value from a menu

=head1 VERSION

This documentation is for C<App::My::Clipboard::Select> version 0.1.
...
Menu items. Arrayref of L<App::My::Clipboard::MenuItem> objects.
Required, non-empty.
...
L<App::My::Clipboard::MenuItem> object (selected item)
...
App::My::Clipboard::MenuItem, Const::Fast, Feature::Compat::Try, Moo,
