package App::My::Clipboard::MenuItems;
...
has '_menu_items_array' => (
  ...
  isa => Types::Standard::ArrayRef [
    Types::Standard::InstanceOf ['App::My::Clipboard::MenuItem'],
  ],
  required    => $TRUE,
  default     => sub { [] },
  handles_via => 'Array',
...
# return: if option selected, then App::My::Clipboard::MenuItem
#         else undef
sub select_item ($self, $menu_name) {
  ...
  # make selection
  my $selection = App::My::Clipboard::Select->new(
    items  => [@items],
    prompt => 'Select item',
...
# • the script that loaded App::My::Clipboard::MenuItems did so by adding
...
App::My::Clipboard::MenuItems - models a group of items in a menu

=head1 VERSION

This documentation applies to L<App::My::Clipboard::MenuItems> version 0.2.
...
It is used by L<App::My::Clipboard::Load>.
...
A menu item. An L<App::My::Clipboard::MenuItem> object. Required.
...
L<App::My::Clipboard::MenuItem> item if selection is made.
...
App::My::Clipboard::MenuItem, Const::Fast, DateTime, DateTime::TimeZone,
