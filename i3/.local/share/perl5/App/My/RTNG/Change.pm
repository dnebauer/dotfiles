...
has '_rtng_library' => (
  is            => 'ro',
  isa           => Types::Standard::InstanceOf ['App::My::RTNG::Library'],
  default       => sub { return App::My::RTNG::Library->new; },
...
# • the script that loaded App::My::RTNG::Change did so by adding its
#   directory to @INC
...
App::My::RTNG::Change - change the S<Radiotray NG> station

=head1 VERSION

This documentation is for C<App::My::RTNG::Change> version 0.1.

=head1 SYNOPSIS

    use App::My::RTNG::Change;

    App::My::RTNG::Change->new_with_options->run;
...
App::My::RTNG::Library, App::My::RTNG::Select, App::My::RTNG::Stations,
