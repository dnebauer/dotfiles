...
App::My::RTNG::Status - display current status of S<Radiotray NG>

=head1 VERSION

This documentation is for C<App::My::RTNG::Status> version 0.1.

=head1 SYNOPSIS

    use App::My::RTNG::Status;

    App::My::RTNG::Status->new_with_options->run;
...
App::My::RTNG::Library, Const::Fast, namespace::clean, Moo, MooX::Options,
