package App::My::RTNG::CommandResult;
...
App::My::RTNG::CommandResult - returned by App::My::RTNG::Library->capture_command_output

=head1 VERSION

This documentation is for C<App::My::RTNG::CommandResult> version 0.1.
...
=head1 SYNOPSIS
    ...
    my $rtng = App::My::RTNG::Library->new();
    my $cmd = [ ... ];
...
Captures results of running a command with the C<App::My::RTNG::Library>
method C<capture_command_output>.
