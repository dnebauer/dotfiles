...
# • the script that loaded App::My::RTNG::Quit did so by adding its
#   directory to @INC
...
App::My::RTNG::Quit - quit the S<Radiotray NG> application

=head1 VERSION

This documentation is for C<App::My::RTNG::Quit> version 0.1.

=head1 SYNOPSIS

    use App::My::RTNG::Quit;

    App::My::RTNG::Quit->new_with_options->run;
