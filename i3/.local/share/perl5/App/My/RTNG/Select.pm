...
App::My::RTNG::Select - user selects a value from a hotkey menu

=head1 VERSION

This documentation is for C<App::My::RTNG::Select> version 0.1.

=head1 SYNOPSIS

    use App::My::RTNG::Select;
    my $selection = App::My::RTNG::Select->new(
      items  => $items,
      prompt => $prompt,
      title  => $title,
    )->run;
