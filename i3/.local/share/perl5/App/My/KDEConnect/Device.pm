package App::My::KDEConnect::Device;
...
App::My::KDEConnect::Device - model the properties of a connectable device

=head1 VERSION

This documentation applies to L<App::My::KDEConnect::Device> version 0.1.

=head1 SYNOPSIS

    use App::My::KDEConnect::Device;
    # ...
    my $device = App::My::KDEConnect::Device->new(
      name => $device_name,
      id   => $device_id,
    );
...
It is used by L<App::My::KDEConnect::Monitor>.
