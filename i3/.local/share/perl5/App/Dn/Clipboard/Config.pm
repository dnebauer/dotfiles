package App::Dn::Clipboard::Config;
...
This documentation is for C<App::Dn::Clipboard::Config> version 0.2.

=head1 SYNOPSIS

    use App::Dn::Clipboard::Config;

    my $conf = App::Dn::Clipboard::Config->new(stem => 'load-clipboard-data');
    my $data = $conf->run;

=head1 DESCRIPTION

Module used by L<App::Dn::Clipboard::Load> to get configuration data.
See L<App::Dn::Clipboard::Load> for more details.
...
See L<App::Dn::Clipboard::Load> for details.
