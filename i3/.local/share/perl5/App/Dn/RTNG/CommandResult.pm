package App::Dn::RTNG::CommandResult;
...
This documentation is for C<App::Dn::RTNG::CommandResult> version 0.1.
...
Captures results of running a command with the C<App::Dn::RTNG::Library>
