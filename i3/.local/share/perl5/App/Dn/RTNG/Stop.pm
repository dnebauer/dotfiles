...
App::Dn::RTNG::Stop - stop any currently playing S<Radiotray NG> station

=head1 VERSION

This documentation is for C<App::Dn::RTNG::Stop> version 0.1.

=head1 SYNOPSIS

    use App::Dn::RTNG::Stop;

    App::Dn::RTNG::Stop->new_with_options->run;
