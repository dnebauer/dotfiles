package App::My::PandocUpdateTemplates::FilepathMapping;
...
App::My::PandocUpdateTemplates::FilepathMapping - model a mapping between repo and stow files

=head1 VERSION

This documentation is for App::My::PandocUpdateTemplates::FilepathMapping
version 0.1.
...
=head1 SYNOPSIS
    ...
    has '_install_filepath_array' => (
      ...
      isa => Types::Standard::ArrayRef [
        Types::Standard::InstanceOf ['App::My::PandocUpdateTemplates::FilepathMapping'],
      ],
      required => $TRUE,
      default  => sub { [] },
