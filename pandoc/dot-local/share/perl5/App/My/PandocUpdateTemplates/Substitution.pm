package App::My::PandocUpdateTemplates::Substitution;
...
App::My::PandocUpdateTemplates::Substitution - model a single text substitution

=head1 VERSION

This documentation is for App::My::PandocUpdateTemplates::Substitution version
0.1.
...
=head1 SYNOPSIS
    ...
    has '_substitutions_array' => (
      ...
      isa => Types::Standard::ArrayRef [
        Types::Standard::InstanceOf ['App::My::PandocUpdateTemplates::Substitution'],
      ],
      required => $TRUE,
      default  => sub { [] },
...
This is an accessory module for L<App::My::PandocUpdateTemplates::Update> that
models a single text substitution.
