package App::My::PandocUpdateTemplates::Repository;
...
has 'substitutions' => (
  ...
  isa => Types::Standard::ArrayRef [
    Types::Standard::InstanceOf [
      'App::My::PandocUpdateTemplates::Substitution'],
  ],
  required => $TRUE,
...
has 'updated_files' => (
  ...
  isa => Types::Standard::ArrayRef [
    Types::Standard::InstanceOf [
      'App::My::PandocUpdateTemplates::FilepathMapping'],    ## no critic (ProhibitDuplicateLiteral)
  ],
  required => $TRUE,
  default  => sub { [] },
...
App::My::PandocUpdateTemplates::Repository - update a local lesspipe.sh installation

=head1 VERSION

This documentation is for App::My::PandocUpdateTemplates::Repository version 0.1.
...
All mappings between downloaded repository files and stow package templates
directory files.

Required. Read-write. Array of
L<App::My::PandocUpdateTemplates::FilepathMapping> instances.
...
L<App::My::PandocUpdateTemplates::Substitution> instances.
...
L<App::My::PandocUpdateTemplates::FilepathMapping> instances. Default: [].
...
App::My::PandocUpdateTemplates::FilepathMapping,
App::My::PandocUpdateTemplates::Substitution, Carp, Const::Fast, English, Env,
