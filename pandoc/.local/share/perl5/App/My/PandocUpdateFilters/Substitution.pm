package App::My::PandocUpdateFilters::Substitution;
...
App::My::PandocUpdateFilters::Substitution - model a single text substitution

=head1 VERSION

This documentation is for App::My::PandocUpdateFilters::Substitution version
0.1.
...
=head1 SYNOPSIS
    ...
    has '_substitutions_array' => (
      ...
      isa => Types::Standard::ArrayRef [
        Types::Standard::InstanceOf ['App::My::PandocUpdateFilters::Substitution'],
      ],
      required => $TRUE,
      default  => sub { [] },
