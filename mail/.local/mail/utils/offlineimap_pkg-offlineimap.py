...
The 'imap4-utf-7' codec defined in this script is used by this configuration
file line:
...
def modified_base64(string):
    ...
    ascii = binascii.b2a_base64(string)
    stripped = ascii.rstrip("\n=")
